...
Public Class WebForm8
    ...
    Private Sub Searchfile1()
        ...
        query = ("SELECT tblapprovers.approverName, tblapprovers.emailAddress,  tblapprovers.approverStatus, tblapprovers.approvDate,tblapprovers.remarks FROM tblmasterlist INNER JOIN tblapprovers ON tblmasterlist.formContolnum = tblapprovers.formControlnum")
